...
(function DocGenerator() {
  ...
  const STATE_DATA = {
    al: {
      ...
      sosName: 'AL Secretary of State',
      nameSearchUrl: 'https://arc-sos.state.al.us/cgi/corpname.mbr/output',
      fees: { llc: 200, scorp: 200, nonprofit: 200, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Business Privilege Tax Return due April 15 -- minimum $100',
      articleTitle: { llc: 'Certificate of Formation', scorp: 'Certificate of Formation', nonprofit: 'Certificate of Formation' },
      statute: { llc: 'AL Code Title 10A Ch. 5A', scorp: 'AL Code Title 10A Ch. 2A', nonprofit: 'AL Code Title 10A Ch. 3' }
    },
    ak: {
      name: 'Alaska',
      abbr: 'AK',
      sosUrl: 'https://www.commerce.alaska.gov/cbp/main/search/entities',
      sosName: 'AK Division of Corporations',
      nameSearchUrl: 'https://www.commerce.alaska.gov/cbp/main/search/entities',
      fees: { llc: 250, scorp: 250, nonprofit: 50, sole: 0 },
      processingTime: '10-15 business days',
      annualReport: 'Biennial Report -- $100 (LLC/Corp); $0 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'AS 10.50', scorp: 'AS 10.06', nonprofit: 'AS 10.20' }
    },
    az: {
      name: 'Arizona',
      abbr: 'AZ',
      sosUrl: 'https://ecorp.azcc.gov/EntitySearch/Index',
      sosName: 'AZ Corporation Commission',
      nameSearchUrl: 'https://ecorp.azcc.gov/EntitySearch/Index',
      fees: { llc: 50, scorp: 60, nonprofit: 40, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Annual Report -- no fee (LLC); $45 (Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'ARS Title 29 Ch. 7', scorp: 'ARS Title 10 Ch. 1-17', nonprofit: 'ARS Title 10 Ch. 24-40' }
    },
    ar: {
      name: 'Arkansas',
      abbr: 'AR',
      sosUrl: 'https://www.sos.arkansas.gov/corps/search_all.php',
      sosName: 'AR Secretary of State',
      nameSearchUrl: 'https://www.sos.arkansas.gov/corps/search_all.php',
      fees: { llc: 45, scorp: 50, nonprofit: 50, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Franchise Tax Report due May 1 -- $150 (LLC/Corp)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'AR Code Title 4 Ch. 32', scorp: 'AR Code Title 4 Ch. 27', nonprofit: 'AR Code Title 4 Ch. 28' }
    },
    ca: {
      name: 'California',
      abbr: 'CA',
    ...
    co: {
      name: 'Colorado',
      abbr: 'CO',
      sosUrl: 'https://www.sos.state.co.us/biz/BusinessEntityCriteriaExt.do',
      sosName: 'CO Secretary of State',
      nameSearchUrl: 'https://www.sos.state.co.us/biz/BusinessEntityCriteriaExt.do',
      fees: { llc: 50, scorp: 50, nonprofit: 50, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Periodic Report due annually -- $10',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'CRS Title 7 Art. 80', scorp: 'CRS Title 7 Art. 101-117', nonprofit: 'CRS Title 7 Art. 121-137' }
    },
    ct: {
      name: 'Connecticut',
      abbr: 'CT',
      sosUrl: 'https://service.ct.gov/business/s/onlinebusinesssearch',
      sosName: 'CT Secretary of State',
      nameSearchUrl: 'https://service.ct.gov/business/s/onlinebusinesssearch',
      fees: { llc: 120, scorp: 250, nonprofit: 50, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $80 (LLC); $150 (Corp)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Certificate of Incorporation', nonprofit: 'Certificate of Incorporation' },
      statute: { llc: 'CT Gen. Stat. Ch. 613', scorp: 'CT Gen. Stat. Ch. 601', nonprofit: 'CT Gen. Stat. Ch. 602' }
    },
    dc: {
      name: 'District of Columbia',
      abbr: 'DC',
      sosUrl: 'https://corponline.dcra.dc.gov/Home.aspx',
      sosName: 'DC Department of Licensing and Consumer Protection',
      nameSearchUrl: 'https://corponline.dcra.dc.gov/Home.aspx',
      fees: { llc: 99, scorp: 220, nonprofit: 80, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Biennial Report -- $300 (LLC/Corp); $80 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'DC Code Title 29 Ch. 8', scorp: 'DC Code Title 29 Ch. 3', nonprofit: 'DC Code Title 29 Ch. 4' }
    },
    de: {
      name: 'Delaware',
      abbr: 'DE',
      sosUrl: 'https://icis.corp.delaware.gov/ecorp/entitysearch/namesearch.aspx',
      sosName: 'DE Division of Corporations',
      nameSearchUrl: 'https://icis.corp.delaware.gov/ecorp/entitysearch/namesearch.aspx',
      fees: { llc: 90, scorp: 89, nonprofit: 89, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Tax -- $300 (LLC); Franchise Tax varies (Corp); $25 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Formation', scorp: 'Certificate of Incorporation', nonprofit: 'Certificate of Incorporation' },
      statute: { llc: 'DE Code Title 6 Ch. 18', scorp: 'DE Code Title 8', nonprofit: 'DE Code Title 8 Subch. XIV' }
    },
    fl: {
      name: 'Florida',
      abbr: 'FL',
      ...
      nameSearchUrl: 'https://dos.fl.gov/sunbiz/search/',
    ...
    hi: {
      name: 'Hawaii',
      abbr: 'HI',
      sosUrl: 'https://hbe.ehawaii.gov/documents/search.html',
      sosName: 'HI Department of Commerce and Consumer Affairs',
      nameSearchUrl: 'https://hbe.ehawaii.gov/documents/search.html',
      fees: { llc: 50, scorp: 50, nonprofit: 25, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Annual Report -- $15 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'HRS Ch. 428', scorp: 'HRS Ch. 414', nonprofit: 'HRS Ch. 414D' }
    },
    ia: {
      name: 'Iowa',
      abbr: 'IA',
      sosUrl: 'https://sos.iowa.gov/search/business/(S(0))/search.aspx',
      sosName: 'IA Secretary of State',
      nameSearchUrl: 'https://sos.iowa.gov/search/business/(S(0))/search.aspx',
      fees: { llc: 50, scorp: 50, nonprofit: 20, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Biennial Report -- $30 (LLC); $60 (Corp); $0 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'IA Code Ch. 489', scorp: 'IA Code Ch. 490', nonprofit: 'IA Code Ch. 504' }
    },
    id: {
      name: 'Idaho',
      abbr: 'ID',
      sosUrl: 'https://sosbiz.idaho.gov/search/business',
      sosName: 'ID Secretary of State',
      nameSearchUrl: 'https://sosbiz.idaho.gov/search/business',
      fees: { llc: 100, scorp: 100, nonprofit: 30, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $0 (all entities)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'ID Code Title 30 Ch. 25', scorp: 'ID Code Title 30 Ch. 29', nonprofit: 'ID Code Title 30 Ch. 30' }
    },
    il: {
      name: 'Illinois',
      abbr: 'IL',
      sosUrl: 'https://www.ilsos.gov/corporatellc/',
      sosName: 'IL Secretary of State',
      nameSearchUrl: 'https://www.ilsos.gov/corporatellc/',
      fees: { llc: 150, scorp: 150, nonprofit: 50, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Annual Report -- $75 (LLC); $75 (Corp); $0 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: '805 ILCS 180', scorp: '805 ILCS 5', nonprofit: '805 ILCS 105' }
    },
    in: {
      name: 'Indiana',
      abbr: 'IN',
      sosUrl: 'https://bsd.sos.in.gov/publicbusinesssearch',
      sosName: 'IN Secretary of State',
      nameSearchUrl: 'https://bsd.sos.in.gov/publicbusinesssearch',
      fees: { llc: 95, scorp: 95, nonprofit: 30, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Biennial Report -- $32 (LLC); Business Entity Report -- $32 (Corp)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'IN Code Title 23 Art. 18', scorp: 'IN Code Title 23 Art. 1', nonprofit: 'IN Code Title 23 Art. 17' }
    },
    ks: {
      name: 'Kansas',
      abbr: 'KS',
      sosUrl: 'https://www.sos.ks.gov/business/business-entities.html',
      sosName: 'KS Secretary of State',
      nameSearchUrl: 'https://www.sos.ks.gov/business/business_entities_registered.aspx',
      fees: { llc: 165, scorp: 90, nonprofit: 20, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $55 (LLC); $55 (Corp); $40 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'KSA Ch. 17 Art. 76', scorp: 'KSA Ch. 17 Art. 60', nonprofit: 'KSA Ch. 17 Art. 61' }
    },
    ky: {
      name: 'Kentucky',
      abbr: 'KY',
      sosUrl: 'https://web.sos.ky.gov/bussearchnew/search',
      sosName: 'KY Secretary of State',
      nameSearchUrl: 'https://web.sos.ky.gov/bussearchnew/search',
      fees: { llc: 40, scorp: 50, nonprofit: 8, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $15 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'KRS Ch. 275', scorp: 'KRS Ch. 271B', nonprofit: 'KRS Ch. 273' }
    },
    la: {
      name: 'Louisiana',
      abbr: 'LA',
      sosUrl: 'https://coraweb.sos.la.gov/commercialsearch/CommercialSearchAnon.aspx',
      sosName: 'LA Secretary of State',
      nameSearchUrl: 'https://coraweb.sos.la.gov/commercialsearch/CommercialSearchAnon.aspx',
      fees: { llc: 100, scorp: 75, nonprofit: 75, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $35 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'LA RS Title 12 Ch. 22', scorp: 'LA RS Title 12 Ch. 1', nonprofit: 'LA RS Title 12 Ch. 2' }
    },
    ma: {
      name: 'Massachusetts',
      abbr: 'MA',
      sosUrl: 'https://corp.sec.state.ma.us/corpweb/CorpSearch/CorpSearch.aspx',
      sosName: 'MA Secretary of the Commonwealth',
      nameSearchUrl: 'https://corp.sec.state.ma.us/corpweb/CorpSearch/CorpSearch.aspx',
      fees: { llc: 500, scorp: 275, nonprofit: 35, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Annual Report -- $500 (LLC); $125 (Corp); $15 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Articles of Organization', nonprofit: 'Articles of Organization' },
      statute: { llc: 'MGL Ch. 156C', scorp: 'MGL Ch. 156D', nonprofit: 'MGL Ch. 180' }
    },
    md: {
      name: 'Maryland',
      abbr: 'MD',
      sosUrl: 'https://egov.maryland.gov/BusinessExpress/EntitySearch',
      sosName: 'MD State Department of Assessments and Taxation',
      nameSearchUrl: 'https://egov.maryland.gov/BusinessExpress/EntitySearch',
      fees: { llc: 100, scorp: 120, nonprofit: 100, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report/Personal Property Return -- $300 (LLC/Corp)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'MD Code Corps. & Assns. Title 4A', scorp: 'MD Code Corps. & Assns. Title 2', nonprofit: 'MD Code Corps. & Assns. Title 5' }
    },
    me: {
      name: 'Maine',
      abbr: 'ME',
      sosUrl: 'https://icrs.informe.org/nei-sos-icrs/ICRS?MainPage=x',
      sosName: 'ME Secretary of State',
      nameSearchUrl: 'https://icrs.informe.org/nei-sos-icrs/ICRS?MainPage=x',
      fees: { llc: 175, scorp: 145, nonprofit: 40, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $85 (LLC/Corp); $35 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Formation', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'ME Rev. Stat. Title 31 Ch. 21', scorp: 'ME Rev. Stat. Title 13-C', nonprofit: 'ME Rev. Stat. Title 13-B' }
    },
    mi: {
      name: 'Michigan',
      abbr: 'MI',
      sosUrl: 'https://cofs.lara.state.mi.us/corpweb/CorpSearch/CorpSearch.aspx',
      sosName: 'MI Department of Licensing and Regulatory Affairs',
      nameSearchUrl: 'https://cofs.lara.state.mi.us/corpweb/CorpSearch/CorpSearch.aspx',
      fees: { llc: 50, scorp: 60, nonprofit: 20, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Statement -- $25 (LLC/Corp); $20 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'MCL Ch. 450 Act 23', scorp: 'MCL Ch. 450 Act 284', nonprofit: 'MCL Ch. 450 Act 162' }
    },
    mn: {
      name: 'Minnesota',
      abbr: 'MN',
      sosUrl: 'https://mblsportal.sos.state.mn.us/Business/Search',
      sosName: 'MN Secretary of State',
      nameSearchUrl: 'https://mblsportal.sos.state.mn.us/Business/Search',
      fees: { llc: 155, scorp: 155, nonprofit: 70, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Annual Renewal -- $0 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'MN Stat. Ch. 322C', scorp: 'MN Stat. Ch. 302A', nonprofit: 'MN Stat. Ch. 317A' }
    },
    mo: {
      name: 'Missouri',
      abbr: 'MO',
      sosUrl: 'https://bsd.sos.mo.gov/BusinessEntity/BESearch.aspx',
      sosName: 'MO Secretary of State',
      nameSearchUrl: 'https://bsd.sos.mo.gov/BusinessEntity/BESearch.aspx',
      fees: { llc: 50, scorp: 58, nonprofit: 25, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Registration -- $0 (all entities); Registration Report required',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'MO Rev. Stat. Ch. 347', scorp: 'MO Rev. Stat. Ch. 351', nonprofit: 'MO Rev. Stat. Ch. 355' }
    },
    ms: {
      name: 'Mississippi',
      abbr: 'MS',
      sosUrl: 'https://corp.sos.ms.gov/corp/portal/c/page/corpBusinessIdSearch/portal.aspx',
      sosName: 'MS Secretary of State',
      nameSearchUrl: 'https://corp.sos.ms.gov/corp/portal/c/page/corpBusinessIdSearch/portal.aspx',
      fees: { llc: 50, scorp: 50, nonprofit: 50, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $0 (LLC/Corp); no fee but must file',
      articleTitle: { llc: 'Certificate of Formation', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'MS Code Title 79 Ch. 29', scorp: 'MS Code Title 79 Ch. 4', nonprofit: 'MS Code Title 79 Ch. 11' }
    },
    mt: {
      name: 'Montana',
      abbr: 'MT',
      sosUrl: 'https://biz.sosmt.gov/search',
      sosName: 'MT Secretary of State',
      nameSearchUrl: 'https://biz.sosmt.gov/search',
      fees: { llc: 70, scorp: 70, nonprofit: 20, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $20 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'MCA Title 35 Ch. 8', scorp: 'MCA Title 35 Ch. 1', nonprofit: 'MCA Title 35 Ch. 2' }
    },
    nc: {
      name: 'North Carolina',
      abbr: 'NC',
      ...
      nameSearchUrl: 'https://www.sosnc.gov/online_services/search/by_title/_Business_Registration',
    ...
    nd: {
      name: 'North Dakota',
      abbr: 'ND',
      sosUrl: 'https://firststop.sos.nd.gov/search/business',
      sosName: 'ND Secretary of State',
      nameSearchUrl: 'https://firststop.sos.nd.gov/search/business',
      fees: { llc: 135, scorp: 100, nonprofit: 40, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $50 (LLC/Corp); $25 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'NDCC Ch. 10-32.1', scorp: 'NDCC Ch. 10-19.1', nonprofit: 'NDCC Ch. 10-33' }
    },
    ne: {
      name: 'Nebraska',
      abbr: 'NE',
      sosUrl: 'https://www.nebraska.gov/sos/corp/corpsearch.cgi',
      sosName: 'NE Secretary of State',
      nameSearchUrl: 'https://www.nebraska.gov/sos/corp/corpsearch.cgi',
      fees: { llc: 105, scorp: 60, nonprofit: 10, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Biennial Report -- $10 (LLC); $26 (Corp); $0 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'NE Rev. Stat. Ch. 21 Art. 1', scorp: 'NE Rev. Stat. Ch. 21 Art. 20', nonprofit: 'NE Rev. Stat. Ch. 21 Art. 19' }
    },
    nh: {
      name: 'New Hampshire',
      abbr: 'NH',
      sosUrl: 'https://quickstart.sos.nh.gov/online/BusinessInquire',
      sosName: 'NH Secretary of State',
      nameSearchUrl: 'https://quickstart.sos.nh.gov/online/BusinessInquire',
      fees: { llc: 100, scorp: 100, nonprofit: 25, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $100 (LLC/Corp); $25 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Formation', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'NH RSA Ch. 304-C', scorp: 'NH RSA Ch. 293-A', nonprofit: 'NH RSA Ch. 292' }
    },
    nj: {
      name: 'New Jersey',
      abbr: 'NJ',
      sosUrl: 'https://www.njportal.com/DOR/BusinessNameSearch',
      sosName: 'NJ Division of Revenue and Enterprise Services',
      nameSearchUrl: 'https://www.njportal.com/DOR/BusinessNameSearch',
      fees: { llc: 125, scorp: 125, nonprofit: 75, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $75 (LLC/Corp); $25 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Formation', scorp: 'Certificate of Incorporation', nonprofit: 'Certificate of Incorporation' },
      statute: { llc: 'NJ Rev. Stat. Title 42 Ch. 2C', scorp: 'NJ Rev. Stat. Title 14A', nonprofit: 'NJ Rev. Stat. Title 15A' }
    },
    nm: {
      name: 'New Mexico',
      abbr: 'NM',
      sosUrl: 'https://portal.sos.state.nm.us/BFS/online/CorporationBusinessSearch',
      sosName: 'NM Secretary of State',
      nameSearchUrl: 'https://portal.sos.state.nm.us/BFS/online/CorporationBusinessSearch',
      fees: { llc: 50, scorp: 100, nonprofit: 25, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'No annual report required; Biennial report for some entities',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'NM Stat. Ch. 53 Art. 19', scorp: 'NM Stat. Ch. 53 Art. 11-18', nonprofit: 'NM Stat. Ch. 53 Art. 8' }
    },
    nv: {
      name: 'Nevada',
      abbr: 'NV',
      sosUrl: 'https://esos.nv.gov/EntitySearch/OnlineEntitySearch',
      sosName: 'NV Secretary of State',
      nameSearchUrl: 'https://esos.nv.gov/EntitySearch/OnlineEntitySearch',
      fees: { llc: 75, scorp: 75, nonprofit: 50, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual List -- $150 (LLC); $150+ (Corp based on shares); $50 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'NRS Ch. 86', scorp: 'NRS Ch. 78', nonprofit: 'NRS Ch. 82' }
    },
    ny: {
      name: 'New York',
      abbr: 'NY',
      ...
      nameSearchUrl: 'https://www.dos.ny.gov/corps/bus_entity_search.html',
    ...
    oh: {
      ...
      sosName: 'OH Secretary of State',
      nameSearchUrl: 'https://businesssearch.ohiosos.gov/',
      fees: { llc: 99, scorp: 99, nonprofit: 99, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'No annual report required for LLCs or Corps',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'ORC Ch. 1706', scorp: 'ORC Ch. 1701', nonprofit: 'ORC Ch. 1702' }
    },
    ok: {
      name: 'Oklahoma',
      abbr: 'OK',
      sosUrl: 'https://www.sos.ok.gov/business/corp/records.aspx',
      sosName: 'OK Secretary of State',
      nameSearchUrl: 'https://www.sos.ok.gov/business/corp/records.aspx',
      fees: { llc: 100, scorp: 50, nonprofit: 25, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Certificate -- $25 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Certificate of Incorporation', nonprofit: 'Certificate of Incorporation' },
      statute: { llc: 'OK Stat. Title 18 Ch. 2', scorp: 'OK Stat. Title 18 Ch. 1', nonprofit: 'OK Stat. Title 18 Ch. 3' }
    },
    or: {
      name: 'Oregon',
      abbr: 'OR',
      sosUrl: 'https://sos.oregon.gov/business/pages/find.aspx',
      sosName: 'OR Secretary of State',
      nameSearchUrl: 'https://sos.oregon.gov/business/pages/find.aspx',
      fees: { llc: 100, scorp: 100, nonprofit: 50, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Annual Report -- $100 (LLC/Corp); $50 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'ORS Ch. 63', scorp: 'ORS Ch. 60', nonprofit: 'ORS Ch. 65' }
    },
    pa: {
      name: 'Pennsylvania',
      abbr: 'PA',
      sosUrl: 'https://www.corporations.pa.gov/search/corpsearch',
      sosName: 'PA Department of State',
      nameSearchUrl: 'https://www.corporations.pa.gov/search/corpsearch',
      fees: { llc: 125, scorp: 125, nonprofit: 125, sole: 0 },
      processingTime: '5-10 business days',
      annualReport: 'Decennial Report -- $70 every 10 years (LLC/Corp)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: '15 Pa.C.S. Ch. 89', scorp: '15 Pa.C.S. Ch. 17-19', nonprofit: '15 Pa.C.S. Ch. 51-59' }
    },
    ri: {
      name: 'Rhode Island',
      abbr: 'RI',
      sosUrl: 'https://business.sos.ri.gov/CorpWeb/CorpSearch/CorpSearch.aspx',
      sosName: 'RI Secretary of State',
      nameSearchUrl: 'https://business.sos.ri.gov/CorpWeb/CorpSearch/CorpSearch.aspx',
      fees: { llc: 150, scorp: 230, nonprofit: 35, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $50 (LLC); $50 (Corp); $0 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'RI Gen. Laws Ch. 7-16', scorp: 'RI Gen. Laws Ch. 7-1.2', nonprofit: 'RI Gen. Laws Ch. 7-6' }
    },
    sc: {
      name: 'South Carolina',
      abbr: 'SC',
      ...
      nameSearchUrl: 'https://businessfilings.sc.gov/businessfiling',
    ...
    sd: {
      name: 'South Dakota',
      abbr: 'SD',
      sosUrl: 'https://sosenterprise.sd.gov/BusinessServices/Business/FilingSearch.aspx',
      sosName: 'SD Secretary of State',
      nameSearchUrl: 'https://sosenterprise.sd.gov/BusinessServices/Business/FilingSearch.aspx',
      fees: { llc: 150, scorp: 150, nonprofit: 30, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $50 (LLC/Corp); $10 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'SDCL Ch. 47-34A', scorp: 'SDCL Ch. 47-1A', nonprofit: 'SDCL Ch. 47-22' }
    },
    tn: {
      name: 'Tennessee',
      abbr: 'TN',
      sosUrl: 'https://tnbear.tn.gov/ECommerce/FilingSearch.aspx',
      sosName: 'TN Secretary of State',
      nameSearchUrl: 'https://tnbear.tn.gov/ECommerce/FilingSearch.aspx',
      fees: { llc: 300, scorp: 100, nonprofit: 100, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $300 minimum (LLC/Corp based on members/shares)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Charter', nonprofit: 'Charter' },
      statute: { llc: 'TN Code Title 48 Ch. 249', scorp: 'TN Code Title 48 Ch. 11-27', nonprofit: 'TN Code Title 48 Ch. 51-68' }
    },
    tx: {
      name: 'Texas',
      abbr: 'TX',
      ...
      nameSearchUrl: 'https://www.sos.state.tx.us/corp/sosda/index.shtml',
    ...
    ut: {
      name: 'Utah',
      abbr: 'UT',
      sosUrl: 'https://secure.utah.gov/bes/',
      sosName: 'UT Division of Corporations and Commercial Code',
      nameSearchUrl: 'https://secure.utah.gov/bes/',
      fees: { llc: 54, scorp: 70, nonprofit: 30, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Renewal -- $18 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Certificate of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'UT Code Title 48 Ch. 3a', scorp: 'UT Code Title 16 Ch. 10a', nonprofit: 'UT Code Title 16 Ch. 6a' }
    },
    va: {
      name: 'Virginia',
      abbr: 'VA',
      ...
      nameSearchUrl: 'https://www.scc.virginia.gov/pages/Business-Entity-Search',
      fees: { llc: 100, scorp: 75, nonprofit: 75, sole: 0 },
      processingTime: '3-5 business days',
    ...
    vt: {
      name: 'Vermont',
      abbr: 'VT',
      sosUrl: 'https://bizfilings.vermont.gov/online/BusinessInquire',
      sosName: 'VT Secretary of State',
      nameSearchUrl: 'https://bizfilings.vermont.gov/online/BusinessInquire',
      fees: { llc: 125, scorp: 125, nonprofit: 75, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Biennial/Annual Report -- $35 (LLC); $45 (Corp); $20 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'VT Stat. Title 11 Ch. 25', scorp: 'VT Stat. Title 11A', nonprofit: 'VT Stat. Title 11B' }
    },
    wa: {
      name: 'Washington',
      abbr: 'WA',
      sosUrl: 'https://ccfs.sos.wa.gov/#/',
      sosName: 'WA Secretary of State',
      nameSearchUrl: 'https://ccfs.sos.wa.gov/#/',
      fees: { llc: 200, scorp: 180, nonprofit: 30, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $60 (LLC); $60 (Corp); $10 (Nonprofit)',
      articleTitle: { llc: 'Certificate of Formation', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'RCW Ch. 25.15', scorp: 'RCW Title 23B', nonprofit: 'RCW Ch. 24.03A' }
    },
    wi: {
      name: 'Wisconsin',
      abbr: 'WI',
      sosUrl: 'https://www.wdfi.org/apps/CorpSearch/Search.aspx',
      sosName: 'WI Department of Financial Institutions',
      nameSearchUrl: 'https://www.wdfi.org/apps/CorpSearch/Search.aspx',
      fees: { llc: 130, scorp: 100, nonprofit: 35, sole: 0 },
      processingTime: '5-7 business days',
      annualReport: 'Annual Report -- $25 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'WI Stat. Ch. 183', scorp: 'WI Stat. Ch. 180', nonprofit: 'WI Stat. Ch. 181' }
    },
    wv: {
      name: 'West Virginia',
      abbr: 'WV',
      sosUrl: 'https://apps.wv.gov/SOS/BusinessEntitySearch/',
      sosName: 'WV Secretary of State',
      nameSearchUrl: 'https://apps.wv.gov/SOS/BusinessEntitySearch/',
      fees: { llc: 100, scorp: 50, nonprofit: 25, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $25 (LLC/Corp/Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'WV Code Ch. 31B', scorp: 'WV Code Ch. 31D', nonprofit: 'WV Code Ch. 31E' }
    },
    wy: {
      name: 'Wyoming',
      abbr: 'WY',
      sosUrl: 'https://wyobiz.wyo.gov/Business/FilingSearch.aspx',
      sosName: 'WY Secretary of State',
      nameSearchUrl: 'https://wyobiz.wyo.gov/Business/FilingSearch.aspx',
      fees: { llc: 100, scorp: 100, nonprofit: 25, sole: 0 },
      processingTime: '3-5 business days',
      annualReport: 'Annual Report -- $60 minimum (LLC/Corp based on assets); $25 (Nonprofit)',
      articleTitle: { llc: 'Articles of Organization', scorp: 'Articles of Incorporation', nonprofit: 'Articles of Incorporation' },
      statute: { llc: 'WY Stat. Title 17 Ch. 29', scorp: 'WY Stat. Title 17 Ch. 16', nonprofit: 'WY Stat. Title 17 Ch. 19' }
    }
  };
